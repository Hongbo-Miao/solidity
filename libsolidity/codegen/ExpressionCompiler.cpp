...
bool ExpressionCompiler::visit(BinaryOperation const& _binaryOperation)
{
	...
	Type const* const& commonType = _binaryOperation.annotation().commonType;
...
bool ExpressionCompiler::visit(FunctionCall const& _functionCall)
{
	...
	else
	{
		...
		case FunctionType::Kind::KECCAK256:
		{
			...
			Type const* const& argType = arguments.front()->annotation().type;
			solAssert(argType, "");
			arguments.front()->accept(*this);
		...
		case FunctionType::Kind::ArrayPush:
		{
			...
			else
			{
				...
				Type const* const& argType = arguments[0]->annotation().type;
		...
		case FunctionType::Kind::ABIEncodeWithSignature:
		{
			...
			if (hasSelectorOrSignature)
			{
				...
				solAssert(arguments.size() >= 1, "");
				Type const* const& selectorType = arguments[0]->annotation().type;
...
bool ExpressionCompiler::visit(MemberAccess const& _memberAccess)
{
	...
	case Type::Category::Struct:
	{
		...
		Type const* const& memberType = _memberAccess.annotation().type;
